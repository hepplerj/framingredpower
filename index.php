...
<!--
<p style="border: 1px dashed rgb(204, 204, 204); padding: 15px; background: #ffffee; ">Note that <em>Framing Red Power</em> is currently undergoing the migration to www.framingredpower.org.  If you discover broken links, pages not working, or anything else that's broken, please contact <a href="mailto:jason.heppler@huskers.unl.edu">Jason Heppler</a>.</p>
-->
	
<p>On the eve of the 1972 presidential election, a caravan of American Indian activists arrived in Washington D.C. as part of a planned 
