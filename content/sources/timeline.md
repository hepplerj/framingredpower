...
var tl;
 function onLoad() {
   ...
   Timeline.loadXML("/xml/papercoverage.xml", function(xml, url) { eventSource.loadXML(xml, url); });
 }
</script>
  ...
  <!--BEGINNING OF FOOTER-->
	<div id="footcolor">
		<div id="footer">
	 		  ...
	 		  <p><a href="/xml/papercoverage.xml" style="float:right;background:orange;color:white;text-transform:none;text-decoration:none;"><strong>&nbsp;XML&nbsp;</strong></a></p>
