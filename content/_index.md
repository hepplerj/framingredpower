...
<div class="hero">
  <div class="hero-image-container">
    <img
      src="/images/BIA-occupation.jpg.webp"
      alt="American Indian activists during the Bureau of Indian Affairs building occupation, November 1972"
      class="hero-image"
      loading="eager"
    />
    <div class="hero-caption">
      Photo by Paul Schmick. Courtesy of the DC Public Library Washington Star Collection.
    </div>
  </div>

  <div class="hero-content">
    <h1>Framing Red Power</h1>
    <p class="subtitle">Newspaper Coverage and the Trail of Broken Treaties</p>
    <p class="description">A digital history project exploring how the media covered the American Indian Movement's 1972 occupation of the Bureau of Indian Affairs headquarters.</p>
    <div class="hero-cta">
      <a href="/narrative/" class="btn btn-primary">Read the Analysis</a>
      <a href="/archive/" class="btn btn-secondary">Browse Documents</a>
    </div>
  </div>
</div>
